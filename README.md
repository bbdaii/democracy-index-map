...
**Live Demo：https://bbdaii.github.io/democracy-index-map/**

以台灣為視角出發的世界地圖互動裝置，整合四個國際研究機構的年度評比指數，讓觀眾用一張地圖看見台灣在世界上的相對位置。

網站首頁是把這台觸控裝置放進3D展間的展示版（three.js、CSS3DRenderer + WebGL），螢幕本體直接是可操作的地圖，拖曳螢幕以外的地方可以轉視角：

![3D展間展示版操作示範](docs/screenshots/showcase-demo.gif)
